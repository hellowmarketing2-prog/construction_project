...
Route::get('/get_service/{id}', [FrontServiceController::class, 'service']);
Route::get('/get_latest_services', [FrontServiceController::class, 'latestServices']);

// rout for contact 
Route::post('/contact_now', [ContactController::class, 'index']);
// get articles
Route::get('/get_articles', [FrontArticleController::class, 'index']);
Route::get('/get_article/{id}', [FrontArticleController::class, 'article']);
...
Route::get('/get_project/{id}', [FrontProjectController::class, 'project']);
...
// get members
Route::get('/get_members', [FrontMemberController::class, 'index']);
