...
const Team = () => {
  ...
  const fetchMembers = async () => {
    const res = await fetch(apiUrl + "get_members", {
      method: "GET",
      headers: {
      ...
      <section className="section-8 bg-light py-5">
        <div className="container">
          <div className="section-header text-center" data-reveal="fade-up">
            ...
            <h2>Our Team</h2>
            <p>
              Our specialists bring together design expertise, project
              management, and on-site execution to deliver successful builds.
            </p>
          </div>
                  ...
                  >
                    <div className="card shadow border-0" key={member.id}>
                      ...
                      <div className="card-body p-3">
                        ...
                        <div className="card-sub-title">{member.job_title}</div>
